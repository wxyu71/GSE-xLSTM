...
from gse_xlstm.data_provider.data_factory import data_provider, data_dict
...
class ForecastingDataModule(DataModule):
    def __init__(
        self,
        ...
        super().__init__(
            task, dataset_name, batch_size, num_workers, persistent_workers, root_path, test_mode=test_mode
        )
